...
public class SQLGrado_Espec {
	private static String SELECT_ALL = "SELECT * FROM GRADO_ESPEC ";
	private static String SELECT_ID = "SELECT grado_id FROM GRADO_ESPEC WHERE nombre = ? ";
	private static String SELECT_ONE = "SELECT * FROM GRADO_ESPEC WHERE grado_id= ? ";
	private static String DELETE = "DELETE FROM GRADO_ESPEC WHERE grado_id = ? ";
	private static String INSERT = "INSERT INTO GRADO_ESPEC(nombre) VALUES ( ? )";
	private static String UPDATE = "UPDATE GRADO_ESPEC SET nombre = ? WHERE grado_id = ? ";

	public List<Grado_Espec> querySelectAll() {
		Connection con = null;
	...
	public Grado_Espec querySelectOne(int id) {
		Connection con = null;
		PreparedStatement stmt = null;
		ResultSet rs = null;
		Grado_Espec grado = null;
